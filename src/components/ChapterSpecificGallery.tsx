...
// Same masonry-with-hover-caption treatment as the book's final Gallery
// page (ChapterGallery.tsx) — kept in sync intentionally so a reader
// sees one consistent gallery style throughout the book.
    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <div className="sticky top-0 z-10 bg-slate-50/90 backdrop-blur-sm border-b border-slate-200 px-8 py-4">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <div>
            <p className="text-sm text-slate-500 font-avenir">Chapter {chapter.number}</p>
